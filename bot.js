...
client.user.setGame(`AlBeRNs Crazy `,"https://www.twitch.tv/dggamingbot")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
              ...
              m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m1) => {
                  ...
                  m.edit(message.member + ', **:timer:**').then( (m) =>{
                      ...
                      m.channel.awaitMessages( m2 => m2.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m2) => {
                          ...
                          m2.delete()
                          message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                            m.edit( message.member + ', **ما الرتبه التي تريد التقديم من اجلها .؟ علما بأن لا يوجد غير بائع و سبورت  🎙**' )
                            setTimeout(() => {
                              m.delete()
                            }, 10000);
                            m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m3) => {
                                ...
                                m3.delete();
                                message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                                  m.edit( message.member + ', **هل سوف ستساعدنا في تحسين السيرفر .؟ 📑**' )
                                  setTimeout(() => {
                                    m.delete()
                                  }, 10000);
                      ...
                      m.edit(message.member + ', **....جارى جمع البيانات**').then( (mtime)=>{
                        ...
                        .addField('**`الرتبه .؟`**',`${ask}`)
                        .addField('**`هل ستقوم بمساعدتنا في نشر السيرفر وتحسينه .؟`**',`${ask2}`)
...
!avatar لرؤيه صورتك
!bcc لارسال الي الجميع بشكل اخر
!kick  لاعطاء كيك
inviteserver لعمل رابط للسيرفر  
!cm لقفل الرومات
!om لفتح الرومات
!mute لعمل ميوت  
!unmute لفك الميوت
