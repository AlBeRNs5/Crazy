...
client.on('guildMemberAdd', Sal => { 
    ...
    .setImage('https://cdn.discordapp.com/attachments/523666109308731403/539830681967263744/welcome-image.png') //هنا حط الصوره الي تبيها
    .setTitle('عضو جديد!')
...
client.on("message", message => {
            if(message.content.startsWith("+appseller")) { /// Mal , Codes //// O҉Z҉X҉ 
              ...
              m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m1) => {
                  ...
                  m.edit(message.member + ', **:timer:**').then( (m) =>{
                      ...
                      m.channel.awaitMessages( m2 => m2.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m2) => {
                          ...
                          m2.delete()
                          message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                            m.edit( message.member + ', **ما هي الاشياء التي تبيعها .؟  🎙**' )
                            setTimeout(() => {
                              m.delete()
                            }, 10000);
                            m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m3) => {
                                ...
                                m3.delete();
                                message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                                  m.edit( message.member + ', **اعطينا دليل انك لست نصاب .. 📑**' )
                                  setTimeout(() => {
                                    m.delete()
                                  }, 10000);
                                  m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m4) => {
                                      ...
                                      m4.delete();
                                      message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                                        m.edit( message.member + ', ** كيف يمكنك مساعدتنا في تطوير السيرفر .؟**' )
                      ...
                      m.edit(message.member + ', **....جارى جمع البيانات**').then( (mtime)=>{
                        ...
                        .addField('**`الاشياء الذي يبيعها .؟`**',`${ask}`)
                        .addField('**`دليل عدم النصب .؟`**',`${ask2}`)
                        .addField('**`كيف يمكنه مساعدتنا .؟`**',`${ask3}`)
...
const config = { prefix: "+", token: "NTI5MzIyOTYxODExODAwMDg0.DzIGFw.g-M_62_3wYC0j1UeKQh10JTby4I" };
const tpoints = {};
const vpoints = {};
hero.config = config;
...
client.on("message", message => {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .setDescription(`
**
+bc لارسال الي الجميع
+user لرؤيه مواصفات حسابك
+avatar لرؤيه صورتك
+cc لارسال الي الجميع بشكل اخر
+kick  لاعطاء كيك
ieserver لعمل رابط للسيرفر  
+cm لقفل الرومات
+om لفتح الرومات
+mute لعمل ميوت  
+unmute لفك الميوت
+clear + Number لمسح الكلام
+hide لاخفاء السيرفر 
+unhide لاظهار السيرفر
+date لرؤيه التاريخ 
+unbanall لفك البان عن الجميع
+ban لاعطاء باند
+app  لعمل تقديم
+gstart لعمل جيف اواي 
+server لرؤيه مواصفات السيرفر
+rules لرؤيه الرتب
+new  لعمل تذكره
+lose لقفل التذكره  
+top لرؤيه من هو الاول في الكلام والفويس
+bot لرؤيه مواصفات البوت
العاب --:
...
client.on("message", message => {
            if(message.content.startsWith("+apphelper")) { /// Mal , Codes //// O҉Z҉X҉ 
        if(!message.channel.guild) return;////////غير البرفكس
                if(message.author.bot) return;
        let channel = message.guild.channels.find("name", "التقديمات")//////dont change any thing
            if(!channel) return message.reply("**لانشاء روم التقديمات +room1 من فضلك اكتب الامر**")/////////dont change
              ...
              m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m1) => {
                  ...
                  m.edit(message.member + ', **:timer:**').then( (m) =>{
                      ...
                      m.channel.awaitMessages( m2 => m2.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m2) => {
                          ...
                          m2.delete()
                          message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                            m.edit( message.member + ', ** ما هي الاشياء التي تملك خبره فيها لكي تساعد الناس بها .؟ 🎙**' )
                            setTimeout(() => {
                              m.delete()
                            }, 10000);
                            m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m3) => {
                                ...
                                m3.delete();
                                message.channel.send( message.member + ', **:timer:**').then( (m) =>{
                                  m.edit( message.member + ', ** كم وقت لك خبره في الديسكورد .؟📑**' )
                                  setTimeout(() => {
                                    m.delete()
                                  }, 10000);
                                  m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m4) => {
                      ...
                      m.edit(message.member + ', **....جارى جمع البيانات**').then( (mtime)=>{
                        ...
                        .addField('**`الاسم`**', `${name}` , true)
                        .addField('**`العمر`**', `${age}` , true)
                        .addField('**`الاشياء الذي يسساعدنا فيها .؟`**',`${ask}`)
                        .addField('**`وقت الخبره .؟`**',`${ask2}`)
                        .addField('**`كيف يمكنه مساعدتنا .؟`**',`${ask3}`)
                        .setFooter(message.author.username,'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')
                        channel.send(embed)
                        }, 2500);
...
**الدفع عند:** **${desc}**
**تم الارسال بواسطة:** ${message.author}
  @everyone - هناك مباع جديد للبوتات . `)
  })
})
  })
})
